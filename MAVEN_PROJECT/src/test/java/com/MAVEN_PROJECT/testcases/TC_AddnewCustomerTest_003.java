...
import com.MAVEN_PROJECT.pageobjects.AddnewCustomerPage;
...
public class TC_AddnewCustomerTest_003 extends BaseClass
{
	...
	public void addNewCustomerTest() throws Exception
	{
		...
		if(driver.findElement(By.tagName("body")).getText().contains(" new customer has been added successfully."))
		{
